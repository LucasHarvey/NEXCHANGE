...
<head>
    ...
    <script async type="text/javascript" src="js/Components/userAccess.js?v=5"></script>
    <script async type="text/javascript" src="js/Components/postCourseSearch.js?v=5"></script>
