...
<head>
    ...
    <script async type="text/javascript" src="js/Components/manage.js?v=5"></script>
        ...
        <div class="main">
            ...
            <div class="userform-wrapper">
                <form id="searchData" class="userform">
                    ...
                    <div class="userfield">
                        <input class="button" type="button" id="download_stats_global" value="Download Global Statistics">
                        <input class="button" type="button" id="download_stats_user" value="Download User Statistics">
                    </div>
