...
$baseQuery = "SELECT n.id, n.user_id as 'author_id', n.course_id, n.created, n.name, n.description, n.taken_on, nf.download_count, nf.distinct_downloads, nf.extension, nf.size, ".
            ...
            "LEFT JOIN users u ON n.user_id=u.id LEFT JOIN courses c ON n.course_id=c.id LEFT JOIN ".
                "(SELECT gnf.note_id, gnf.extension, gnf.size, gnfd.totalcount as download_count, gnfd.countdist as distinct_downloads FROM notefiles gnf LEFT JOIN ".
