...
$GLOBALS['NEXCHANGE_DOMAIN'] = "nexchange-git-lucas-lucasharvey.c9users.io"; //used for cookie access
...
$GLOBALS['NEXCHANGE_ALLOWED_TRIES_UI'] = 5; // number of failed login attempts allowed
