...
$GLOBALS['NEXCHANGE_ALLOWED_TRIES_LOGIN'] = 5; // number of failed login attempts allowed
...
$GLOBALS['NEXCHANGE_ALLOWED_TRIES_UI'] = 15; // number of failed login attempts allowed
$GLOBALS['NEXCHANGE_BRUTE_UI_INTERVAL'] = 60; // number of seconds for brute force prevention of uilog
$GLOBALS['NEXCHANGE_BRUTE_UI_WAIT'] = 2*60; // number of seconds user must wait to log another ui error
