...
sed -i -e 's/$password = "";/$password = "Nex:2017";/g' v1/_database.php
rm -rf v1/Files;
rm -rf v1/CoursesCSV;
...
echo "Part 4 -- Deleting Backup Directory";
cd /home/nexuser
rm -rf /home/nexuser/_BACKUP

echo "Part 5 -- Changing Permissions";
cd /var/www/html
